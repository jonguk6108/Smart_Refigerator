...
matching_values = [[0 for col in range(outer_size)] for row in range( inner_size )]
threshold = 0.5

for i in range(inner_size) :
    img1 = cv2.imread('./test_set_7/inner0/inner_' + str(i) + '.png')
    for j in range(outer_size):
        img2 = cv2.imread('./test_set_6/outer_crop_' + str(j) + '.png')
